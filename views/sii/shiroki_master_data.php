...
<div class="content-wrapper">
    ...
    <div class="modal fade" id="tambahdata">
        ...
        <form action="<?php echo base_url(); ?>shiroki_tambah_master_data" method="POST">
                    ...
                    <div>
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="kanban_shi" required></td>
                            </tr>
                            <tr>
                                <th>Deskripsi</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({ 
            ...
            stateSave: true,
            ajax: {
                url: "<?php echo site_url('shiroki_master_data_ajax')?>",
                type: "POST",
                data: function ( data ) {
    ...
    function cek_part_name(elem){
        if($(elem).val().length >= 8){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>shiroki_cek_part_name",
                data: {
                    part_name: $(elem).val()
                },
                cache: false,
