			...
			<div class="row">
				<div class="col-12">
					<h1>
                        ...
                        <a href="<?php echo base_url(); ?>shiroki_manifest_input" class="btn btn-success float-right"><i class="fa fa-upload"></i> Input Data</a>
					</h1>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({ 
            ...
            stateSave: true,
            ajax: {
                url: "<?php echo site_url('shiroki_manifest_ajax')?>",
                type: "POST",
                data: function ( data ) {
